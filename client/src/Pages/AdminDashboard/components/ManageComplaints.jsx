...
export default function ManageComplaints({ role }) {
  ...
  return (
    <section className="fm-admin-complaints">
      <div className="fm-admin-complaints__header">
        <div>
          <span className="fm-admin-complaints__eyebrow">
          ...
          <p>
            Track customer complaints, post operational responses, and update
            complaint status from one controlled workspace.
          </p>
        </div>

        <button
          type="button"
          className="fm-admin-complaints__btn fm-admin-complaints__btn--outline"
      ...
      <div className="fm-admin-complaints__summaryGrid">
        <article className="fm-admin-complaints__summaryCard">
          <span>
      ...
      {message?.text ? (
        <div
          className={`fm-admin-complaints__notice fm-admin-complaints__notice--${message.type}`}
          role="status"
          aria-live="polite">
      ...
      {err ? (
        <div
          className="fm-admin-complaints__notice fm-admin-complaints__notice--error"
          role="status"
          aria-live="polite">
          <X size={16} />
          <span>{err}</span>
      ...
      {isCustomer ? (
        <form
          className="fm-admin-complaints__card"
          onSubmit={handleCreate}
          autoComplete="off">
          <div className="fm-admin-complaints__cardHeader">
            <div>
          ...
          <div className="fm-admin-complaints__formGrid">
            <div className="fm-admin-complaints__field">
            ...
            <div className="fm-admin-complaints__field fm-admin-complaints__field--wide">
          ...
          <div className="fm-admin-complaints__actions">
            <button
              type="submit"
              className="fm-admin-complaints__btn fm-admin-complaints__btn--primary">
              Submit Complaint
            </button>
          </div>
        </form>
      ) : (
        <section className="fm-admin-complaints__card">
          <div className="fm-admin-complaints__toolbar">
            <div>
              <span>Complaint filters</span>
              <h2>Review Queue</h2>
            </div>

            <div className="fm-admin-complaints__tools">
              <label className="fm-admin-complaints__select">
                <select
                  value={statusFilter}
              ...
              <label className="fm-admin-complaints__search">
                <Search size={16} />
                <input
                  type="search"
                  value={query}
      ...
      <section className="fm-admin-complaints__card">
        ...
        {loading ? (
          <div className="fm-admin-complaints__empty">
            <RefreshCw size={24} />
          ...
          <div className="fm-admin-complaints__grid">
            {filtered.map((complaint) => (
              <article
                className="fm-admin-complaints__item"
                key={complaint._id}>
                <header className="fm-admin-complaints__itemHeader">
                  <h3>{complaint.title || "Untitled complaint"}</h3>

                  <span
                    className={`fm-admin-complaints__status ${statusClass(
                      complaint.status,
                    )}`}>
                ...
                <div className="fm-admin-complaints__meta">
                  <span>
                  ...
                  {complaint.booking ? (
                    <span>
                      ...
                      {typeof complaint.booking === "string"
                        ? complaint.booking
                        : complaint.booking?._id || "Linked booking"}
                    </span>
                  ) : null}
                </div>

                {complaint.details ? (
                  <p className="fm-admin-complaints__details">
                    {complaint.details}
                  </p>
                ) : null}

                {complaint.responses?.length ? (
                  <div className="fm-admin-complaints__timeline">
                ...
                {!isCustomer ? (
                  <div className="fm-admin-complaints__rowActions">
                    <button
                      type="button"
                      className="fm-admin-complaints__btn fm-admin-complaints__btn--primary"
                      onClick={() => {
      ...
      {selected ? (
        <div
          className="fm-admin-complaints-modal"
          onClick={() => setSelected(null)}
          role="dialog"
          aria-modal="true"
          aria-label="Respond to complaint">
          <div
            className="fm-admin-complaints-modal__card"
            onClick={(event) => event.stopPropagation()}>
            <div className="fm-admin-complaints-modal__header">
              <div>
              ...
              <button
                type="button"
                className="fm-admin-complaints__iconAction"
                onClick={() => setSelected(null)}
                aria-label="Close">
                <X size={16} />
              </button>
            ...
            <form
              className="fm-admin-complaints__responseForm"
              ...
              <div className="fm-admin-complaints__chips">
                {[
              ...
              <div className="fm-admin-complaints__field">
                ...
                <div className="fm-admin-complaints__statusOptions">
              ...
              <div className="fm-admin-complaints-modal__actions">
                <button
                  type="submit"
                  className="fm-admin-complaints__btn fm-admin-complaints__btn--primary">
                  Send Response
